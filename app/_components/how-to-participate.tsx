...
export const HowToParticipate = () => {
    const howtoparticipate = [
        ...
        },
        {
            id: 1,
            icon: Coins,
            text: 'SELECT AMOUNT TO INVEST'
        },
        {
            id: 3,
            icon: CheckCircle,
            text: 'PURCHASE RIO TOKENS'
        }
    ];

    return (
        <div className="w-full px-2 z-0" style={{ marginBottom: '1.5rem' }} id='how-it-works'>
            <AppHeading
                variant='h2'
            ...
            <div className="flex justify-between gap-3 lg:gap-4" style={{ marginTop: '1rem' }}>
                {howtoparticipate.map((itm, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className="relative bg-black/60 backdrop-blur-sm border border-sky-500/20 rounded-xl lg:rounded-2xl shadow-xl hover:shadow-2xl hover:border-sky-400/40 transition-all duration-300 hover:scale-105 h-full flex flex-col items-center justify-center" style={{ padding: '.5rem 0' }}>
                                ...
                                <div className="relative z-10 flex flex-col items-center gap-2 lg:gap-3">
                                    ...
                                    <div className="text-[.6rem] lg:text-sm font-semibold text-white uppercase tracking-wide text-center leading-tight">
                                        {itm.text}
                                    </div>
                                </div>
