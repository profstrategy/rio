    ...
    return (
        <section className='flex flex-col w-full z-0'>
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-2 lg:mb-3 text-center tracking-tight">
                ONBONK <span className="text-3xl lg:text-4xl font-bold bg-linear-to-r from-orange-400 to-cyan-400 bg-clip-text text-transparent tracking-tight">IDO LAUNCH </span>
            </h2>
